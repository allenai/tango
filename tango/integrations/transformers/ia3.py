...
def modify_with_ia3(transformer: PreTrainedModel, config: WithIA3Config, *, only_ia3_requires_grad: bool = True):
    """
    A function to add ia3 adaptors to the given transformer. Code modified from 
    [t-few](https://github.com/r-three/t-few/blob/217cfa3b73aa66a07594826e4ebbbc516b331461/src/models/lora.py) and Qinyuan Ye
    ...
    if only_ia3_requires_grad:
        ...
        for p_name, v in dict(transformer.named_parameters()).items():
